...
%{
blocked_rand_QB_large - Blocked randomized algorithm for finding QB factorization of a
...
%}
function [Q, B, error] = blocked_rand_QB_large(A, block_size, epsillon, k, s)
